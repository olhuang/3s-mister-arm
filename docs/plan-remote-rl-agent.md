...
- [ ] Phase 10: promote behavior cloning from a DQN warm-start helper into the primary imitation-policy line
  ...
  - [ ] Phase 10C event-aware BC negative/margin objectives: add explicit contrastive losses for low defense, projectile defense timing, punish opportunities, and bad demonstrations instead of relying only on sample downweighting.
