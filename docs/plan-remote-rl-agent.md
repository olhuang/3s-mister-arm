...
- [ ] Phase 10: promote behavior cloning from a DQN warm-start helper into the primary imitation-policy line
  ...
  - [ ] Phase 10D AWR/AWAC-style weighted imitation: compute event-derived returns/advantages and train the policy with advantage-weighted behavior cloning once Phase 10A/B live behavior is stable.
